...
c ... Get name of binary file
      n = 1
      call getarg(n, biname, status)
c ... Check that binary file exists
      call chkbin(biname)

c ... Get name of ascii file
      n = 2
      call getarg(n, ascname, status)
