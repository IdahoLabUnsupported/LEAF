...
////////////////////////////////////////////////////////////////////////////////
StringPtr StackTraceElement::ToString() const
{
    return Create< String >(
        java::CallMethod< jobject >( m_jobject, GetJmid( "toString" ) ) );
}
////////////////////////////////////////////////////////////////////////////////
jclass const& StackTraceElement::GetJclass()
{
    static jclass const clazz =
        java::FindClass( "java/lang/StackTraceElement" );
    return clazz;
}
////////////////////////////////////////////////////////////////////////////////
jmethodID const& StackTraceElement::GetJmid(
